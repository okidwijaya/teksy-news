...
export default function NotFound() {
    return (
        <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-[#D4D4D4] via-[#121212] to-[#000000] flex items-center justify-center">
            ...
            <div className="absolute top-[70%] right-[15%] text-4xl opacity-30 animate-bounce-delayed">
                🚀
            </div>
            <div className="absolute top-[40%] left-[5%] text-4xl opacity-30 animate-bounce">
                ⚡
            </div>
            ...
            <div className="relative z-10 text-center px-8 max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link
                        href="/"
                        className="w-full sm:w-auto px-8 py-4 bg-white text-indigo-600 rounded-full font-semibold text-base shadow-[0_10px_30px_rgba(0,0,0,0.2)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-all duration-300"
                    >
                        Back to Home
                    </Link>
                    <button
                        onClick={() => window.history.back()}
                        className="w-full sm:w-auto px-8 py-4 bg-white/20 text-white rounded-full font-semibold text-base backdrop-blur-md border-2 border-white/30 hover:bg-white/30 hover:-translate-y-1 transition-all duration-300"
                    >
                        Go Back
                    </button>
                </div>
